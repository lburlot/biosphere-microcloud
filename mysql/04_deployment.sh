...
# The password is generated by the container so we need to sleep a bit
# Another option is to generate it (with the same command than the docker container: pwgen -1 32)
